# -*- coding: utf-8 -*-
"""
Created on Fri May 15 22:23:30 2020
...
# Function initial_classifier(model, hidden_units) creates a classifier with the correct number of input layers
def initial_classifier(model, hidden_units):
    # Check that hidden layers has been input
    if type(hidden_units) == type(None): 
        hidden_units = 4096 #hyperparameters
